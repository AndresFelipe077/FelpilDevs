!(function (t, e) {
  ...
  Object.defineProperty(g, "version", {enumerable: !0, configurable: !0, writable: !0, value: "5.0.32"}),
  ...
  class I extends m {
    ...
    startDecelAnim() {
      ...
      u && (h = u / (1 / (1 - p) - 1)),
        ...
        ("y" === this.option("lockAxis") ||
          ("xy" === this.option("lockAxis") && "y" === this.lockedAxis && e(g) === this.minScale)) &&
          (h = u = 0),
        ("x" === this.option("lockAxis") ||
          ("xy" === this.option("lockAxis") && "x" === this.lockedAxis && e(g) === this.minScale)) &&
          (d = f = 0);
    ...
    applyChange({
      ...
      (this.targetScale < this.scale || Math.abs(n - 1) > 0.1 || this.panMode === A || !1 === d) &&
        !h &&
    ...
    panWithMouse(t, i = this.option("mouseMoveFriction")) {
      ...
      (g += 0.5 * (o.bottom - o.top)),
        this.applyChange({panX: p - this.target.e, panY: g - this.target.f, friction: i});
    }
    zoomWithWheel(t) {
  ...
  Object.defineProperty(I, "defaults", {enumerable: !0, configurable: !0, writable: !0, value: w}),
  ...
  const H = (t) => {
      ...
      return Object.assign(
        {html: "", el: null, isDom: !1, class: "", customClass: "", index: -1, dim: 0, gap: 0, pos: 0, transition: !1},
        t
      );
    },
  ...
  class Q extends m {
    ...
    processOptions() {
      ...
      (n === this.bp && this.state !== B.Init) ||
        ...
        this.state === B.Ready &&
          (i.initialSlide =
            (null === (e = null === (t = this.pages[this.page]) || void 0 === t ? void 0 : t.slides[0]) || void 0 === e
              ? void 0
              : e.index) || 0),
    ...
    initLayout() {
      ...
      i || ((i = document.createElement("div")), C(i, e.viewport), i.append(...F(t, `.${e.slide}`)), t.prepend(i)),
    ...
    getProgress(t, i = !1, n = !1) {
      ...
      this.isInfinite &&
        !0 !== n &&
        ((h = e((l - r.pos + a) / (1 * r.dim), 1e3)), (d = e((l - r.pos - a) / (1 * r.dim), 1e3)));
    ...
    getPageFromPosition(t) {
      ...
      h && (p += 0.5 * e),
        this.isInfinite
          ? (p < l.pos - 0.5 * c.gap && ((p -= i), (f = -1)), p > c.pos + c.dim + 0.5 * c.gap && ((p -= i), (f = 1)))
          : (p = Math.max(l.pos || 0, Math.min(p, c.pos)));
      let g = c,
        m = n.find((t) => {
      ...
      return m || (m = c), (u = this.getPageForSlide(m.index)), (d = u + f * a), {page: d, pageIndex: u};
    }
    setPageFromPosition() {
  ...
  const ft = () => {
    ...
    gt = () => {
      ...
      if ((i && i.dispatchEvent(new CustomEvent("click", {bubbles: !0, cancelable: !0})), Te.getInstance())) return;
  ...
  class wt extends _ {
        ...
        this.process(t, e).then(
          (e) => {
            ...
            if (o && r) {
              ...
              !r.opacity &&
                a > 1200 &&
                ((c = document.createElement("img")), C(c, "fancybox-ghost"), (c.src = o), n.appendChild(c));
              const h = () => {
                c &&
                  (C(c, "f-fadeFastOut"),
                  setTimeout(() => {
    ...
    getZoomInfo(t) {
      ...
      let {top: l, left: c, width: h, height: d} = n.getBoundingClientRect(),
        {top: u, left: f, fitWidth: p, fitHeight: g} = s.contentRect;
      if (!(h && d && p && g)) return !1;
      const m = s.container.getBoundingClientRect();
      (f += m.left), (u += m.top);
      const v = -1 * (f + 0.5 * p - (c + 0.5 * h)),
        b = -1 * (u + 0.5 * g - (l + 0.5 * d)),
        y = h / p;
      let w = this.option("zoomOpacity") || !1;
      return "auto" === w && (w = Math.abs(h / d - p / g) > 0.1), {x: v, y: b, scale: y, opacity: w};
    }
    attach() {
      const t = this,
        e = t.instance;
  ...
  class Lt extends _ {
    ...
    setIframeContent(t) {
      ...
      if ("iframe" !== t.type || !1 === o)
        return s.setAttribute("src", t.src + ""), n.setContent(t, s, !1), this.resizeIframe(t), void n.revealContent(t);
      n.showLoading(t),
        (s.onload = () => {
  ...
  let $t = class extends _ {
    ...
    onClick(t) {
      ...
      let [d, u] = o(c - l, h),
        [f, p] = o(c + l, h);
      u && p
        ? ((a = Math.abs(c - u.getBoundingClientRect().right) < Math.abs(c - p.getBoundingClientRect().left) ? d : f),
          a === n && (a = a === d ? f : d))
        : u
        ? (a = d)
        : p && (a = f),
    ...
    getShift(t) {
      ...
      return (
        0 === t
          ? ((p = g * Math.abs(d)), v && 1 === d && (p -= g * Math.abs(u)))
          : t === h
          ? ((p = g * Math.abs(u) * -1), m && -1 === u && (p += g * Math.abs(d)))
          : m || v
          ? ((p = -1 * g), (p += g * Math.abs(d)), (p += g * (1 - Math.abs(u))))
          : (p = g * f),
        p
      );
    }
  ...
  class Qt extends _ {
    ...
    onClick(t) {
      ...
      if (void 0 !== r.fancyboxToggleThumbs)
        return (
          t.preventDefault(), t.stopPropagation(), void (null === (e = n.plugins.Thumbs) || void 0 === e || e.toggle())
        );
  ...
  class Te extends m {
          ...
          if (!t.isInfinite) {
            for (const i of e.querySelectorAll("[data-fancybox-next]"))
              t.page < t.pages.length - 1
                ? (i.removeAttribute(ue), i.removeAttribute(fe))
                : (i.setAttribute(ue, ""), i.setAttribute(fe, "-1"));
          ...
          for (const t of e.querySelectorAll("[data-fancybox-download]")) {
            ...
            n
              ? (t.removeAttribute(ue),
                ...
                t.setAttribute(ge, n),
                t.setAttribute(pe, e || n),
                t.setAttribute("target", "_blank"))
              : (t.setAttribute(ue, ""), t.setAttribute(fe, "-1"), t.removeAttribute(ge), t.removeAttribute(pe));
          }
        }),
      ...
      this.pwt && r - this.pwt < 300
        ...
        : ((this.pwt = r),
          ...
          t.defaultPrevented ||
            ("close" === i
              ? (t.preventDefault(), this.close(t))
              : "slide" === i && (n(e) || (t.preventDefault(), this[a > 0 ? "prev" : "next"]()))));
    }
    onKeydown(t) {
      ...
      if (("Tab" === t.key ? C(this.container, ae) : P(this.container, ae), t.ctrlKey || t.altKey || t.shiftKey))
        return;
    ...
    animate(t = null, e = "", i) {
      ...
      const n = (s) => {
        s.target === t &&
          ...
          (t.removeEventListener("animationend", n), delete t.dataset.animationName, i && i(), P(t, e));
      };
    ...
    endIdle() {
      this.clearIdle(),
        this.idle && !this.isClosing() && ((this.idle = !1), P(this.container, "is-idle"), this.emit("endIdle"));
    }
    resetIdle() {
    ...
    static fromSelector(t, e, i) {
      ...
      return !!a && ((o = f({}, a.get(s) || {}, o)), !!o && Te.fromNodes(Array.from(n.querySelectorAll(s)), o));
    }
  ...
  Object.defineProperty(Te, "version", {enumerable: !0, configurable: !0, writable: !0, value: "5.0.32"}),
    Object.defineProperty(Te, "defaults", {enumerable: !0, configurable: !0, writable: !0, value: at}),
    Object.defineProperty(Te, "Plugins", {enumerable: !0, configurable: !0, writable: !0, value: te}),
    Object.defineProperty(Te, "openers", {enumerable: !0, configurable: !0, writable: !0, value: new Map()}),
    (t.Carousel = Q),
    (t.Fancybox = Te),
    (t.Panzoom = I);
});
